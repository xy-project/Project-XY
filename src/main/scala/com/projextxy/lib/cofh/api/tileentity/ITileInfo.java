package com.projextxy.lib.cofh.api.tileentity;

import com.projextxy.lib.cofh.api.block.IBlockInfo;
...
public interface ITileInfo {
     ...
     * @param debug  If true, the tile should return "debug" information.
     */
